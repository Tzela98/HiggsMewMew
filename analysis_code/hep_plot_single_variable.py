...
def plot_single_object_variable(variable: str, bin_range: tuple, bin_number: int, region_index):
    ...
    hep.histplot([hist_background_top, hist_background_other, hist_background_DYJets], bins=bin_edges, stack=True, ax=ax1, color=colors, label=['Other', 'Top', 'DYJets'])
...
def main():
    ...
    for variable in list_of_variables:
        for i in [0, 1, 3]:
            plot_single_object_variable(variable, range, 30, i)
